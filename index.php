	...
	<div class="sidebar-menu">
		...
		<div class="sidebar-menu-inner">
			...
			<header class="logo-env">
				...
				<div class="logo">
					<a href="index.html">
						<img src="assets/images/Logo App vl11.png" width="100" alt="" />
					</a>
				</div>
		...
		switch ($menu) 
			{
				...
				case 'game':
					require_once('menu/view_game.php');
					break;

					case 'unity':
						require_once('menu/view_unity.php');
						break;
 
					case 'voter':
							require_once('menu/view_voter.php');
							break;
