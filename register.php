					...
					<div class="step current" id="step-1">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="name" id="name" placeholder="Nom" autocomplete="off" />
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="phone" id="phone" placeholder="telephone" data-mask="phone" autocomplete="off" />
							</div>
						</div>
					...
					<div class="step" id="step-2">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="username" id="username" placeholder="prenom" data-mask="[a-zA-Z0-1\.]+" data-is-regex="true" autocomplete="off" />
							</div>
						</div>
